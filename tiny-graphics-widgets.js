...
const Canvas_Widget = widgets.Canvas_Widget =
   class Canvas_Widget {
       ...
       constructor(element, initial_scenes, options = {}) {
           ...
           const rules = [".canvas-widget { width: 0px; background: White; margin-top: 0px }",
...
const Controls_Widget = widgets.Controls_Widget =
   class Controls_Widget {
       ...
       constructor(element, scenes) {
        ...
        ".controls-widget table.control-box { width: 1080px; border:1px; margin-left:200px; max-height:380px; " +
        "transition:.5s; overflow-y:scroll; background:white }",
        ".controls-widget table.control-box:hover { max-height:500px }",
        ".controls-widget table.control-box td { overflow:hidden; border:1px; background: white; border-radius:10px; width: 540px;}",
        ".controls-widget table.control-box td .control-div { background: white; height:338px; padding: 10px 10px 10px 30px; }",
        ...
        ".controls-widget table.control-box .control-title { padding:7px 40px; color:black; background:white;}",
        ...
        ".dropdown-content { display:inline-block; transition:.2s; transform: scaleY(0); overflow:hidden; position: absolute; \
                              z-index: 1; background:white; padding: 16px; margin-left:30px; min-width: 100px; \
                              border-radius:10px }",
        ".dropdown-content a { color: black; padding: 4px 4px; display: block }",
        ".dropdown a:hover { background: #56A969}",
        ".controls-widget button { background: white; color: #deebff; padding: 5px; border-radius:12px; \
                                   transition: background .3s, transform .3s }",
        ".controls-widget button:hover, button:focus { transform: scale(1.1); color:#56A969}",
