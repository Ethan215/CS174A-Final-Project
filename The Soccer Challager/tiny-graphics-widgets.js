   ...
   class Controls_Widget {
       ...
       constructor(element, scenes) {
           const rules = [".controls-widget * { font-family: monospace }",
               ...
               ".controls-widget table.control-box { width: 0px; border:1px; margin:0; max-height:0px; " +
               "transition:.5s; overflow-y:scroll; background:white }",
               ".controls-widget table.control-box:hover { max-height:0px }",
               ".controls-widget table.control-box td { overflow:hidden; border:1px; background:Black; border-radius:10px; width: 0px;}",
               ".controls-widget table.control-box td .control-div { background: White; height:0px; padding: 0px 0px 0px 0px; }",
               ...
               ".controls-widget table.control-box .control-title { padding:0px 0px; color:white; background:#252424;}",
               ...
               ".dropdown-content { display:inline-block; transition:.2s; transform: scaleY(0); overflow:hidden; position: absolute; \
                                     z-index: 1; background:#E8F6FF; padding: 16px; margin-left:0px; min-width: 0px; \
                                     border-radius:10px }",
               ...
               ".show { transform: scaleY(1); height:0px; overflow:auto }",
