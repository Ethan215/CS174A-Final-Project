...
export class Assignment4 extends Scene {
    ...
    constructor() {
        ...
        this.materials = {
            ...
            star: new Material(new Texture_Rotate(), {
                color: hex_color("#000000"),
                ambient: 1,
                texture: new Texture("assets/stars.png", "NEAREST")
            }),
            earth: new Material(new Texture_Rotate(), {
                color: hex_color("#000000"),
                ambient: 1,
    ...
    display(context, program_state) {
        ...
        //this.shapes.box_1.draw(context, program_state, model_transform, this.materials.star)
